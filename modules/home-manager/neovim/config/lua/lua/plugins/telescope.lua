return {
    ...
    tag = "0.1.5",
    dependencies = {"nvim-lua/plenary.nvim", "radyz/telescope-gitsigns", "stevearc/aerial.nvim",
                    "nvim-tree/nvim-tree.lua", "ahmedkhalf/project.nvim", "lewis6991/gitsigns.nvim"},
    config = function()
